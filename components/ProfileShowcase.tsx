...
import { PROFILE_IMAGES, getImageSrc } from '@/lib/image-constants'
...
export default function ProfileShowcase() {
  const profiles = [
    {
      ...
      image: getImageSrc(PROFILE_IMAGES.ayesha),
      rating: 4.9,
      verified: true,
      premium: true,
      online: true,
    ...
    },
    {
      ...
      image: getImageSrc(PROFILE_IMAGES.ahmed),
      rating: 4.8,
      verified: true,
      premium: false,
      online: false,
    ...
    },
    {
      ...
      image: getImageSrc(PROFILE_IMAGES.fatima),
      rating: 4.9,
      verified: true,
      premium: true,
      online: true,
    ...
    },
    {
      ...
      image: getImageSrc(PROFILE_IMAGES.hassan),
      rating: 4.7,
      verified: true,
      premium: false,
      online: true,
    ...
    },
    {
      ...
      image: getImageSrc(PROFILE_IMAGES.zara),
      rating: 4.8,
      verified: true,
      premium: true,
      online: false,
    ...
    },
    {
      ...
      image: getImageSrc(PROFILE_IMAGES.usman),
      rating: 4.9,
      verified: true,
      premium: false,
      online: true,
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-slate-50 via-teal-50/30 to-emerald-50/30 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-br from-teal-200/20 to-emerald-200/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-br from-cyan-200/20 to-teal-200/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-teal-700 font-semibold text-sm">Featured Profiles</span>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {profiles.map((profile, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-teal-500/25 transition-all duration-500"
              style={{
              ...
              <div className="relative h-80 overflow-hidden">
                ...
                >
                  ...
                  <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 bg-teal-500/80 backdrop-blur-xl border border-teal-400/50 text-white rounded-full flex items-center justify-center hover:bg-teal-500 transition-all duration-300"
                  >
