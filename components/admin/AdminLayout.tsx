    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="fixed bottom-6 right-6 z-30">
        ...
        <motion.button
          ...
          className="w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-2xl flex items-center justify-center hover:shadow-blue-500/25 transition-all duration-300"
        >
          <motion.div
